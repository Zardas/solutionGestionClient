    ...
    class GestionRelationClient_DBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Models.Client>().HasData(
                ...
                new Models.Client() { Login="Stan", Mail="staan@sp.ca", MotDePasse="mdpTest", Nom="Marsh", Prenom="Stan", Telephone="23151321"}
            );

            modelBuilder.Entity<Models.Compte>().HasData(
                new Models.Compte() { CompteId = 1, ClientId = 1, NomCompte = "compteBidon" }
            );

            modelBuilder.Entity<Models.Panier>().HasData(
                new Models.Panier() { PanierId = 1, CompteId=1 } // Panier 9999 est le panier par défaut
            );
            */
