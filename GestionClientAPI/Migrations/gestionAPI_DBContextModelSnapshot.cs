...
namespace GestionClientAPI.Migrations
{
    ...
    partial class gestionAPI_DBContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("GestionClientAPI.Models.Administrateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UtilisateurId = 4,
                            Login = "Butters",
                            MotDePasse = "G6K9uekzJ2k/7tpxkHZvEVa5yoDOW+tELPPEyDKeGFs=",
                            Mail = "bt@sp.ca",
            ...
            modelBuilder.Entity("GestionClientAPI.Models.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UtilisateurId = 5,
                            Login = "ClientDefaut",
                            MotDePasse = "iGmj0/VzeGneyVuucE40IMekMljU2iQKD0+0TSpW+Pw=",
                            Age = 0,
                            GestionnaireAssocieId = 0,
                            Mail = "er@ezr.cq",
                            Nom = "Defaut",
                            Solde = 0
                        });
